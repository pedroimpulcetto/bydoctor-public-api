---
title: "List Professional Schedules — GET /schedules | ByDoctor"
sidebarTitle: "List"
description: "List all professionals and their configured weekly working hours. Filter by professional ID and paginate with cursor-based pagination."
---
