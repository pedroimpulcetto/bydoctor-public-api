---
title: "Cancel Appointment — DELETE /appointments/{id}"
sidebarTitle: "Cancel"
description: "DELETE /appointments/{id} — cancel an appointment. Optionally notify the patient via WhatsApp about the cancellation."
---
