---
title: "Update Appointment — PATCH /appointments/{id}"
sidebarTitle: "Update"
description: "PATCH /appointments/{id} — update appointment status, time, or notes. Triggers WhatsApp notification if notify_patient is true."
---
...
<ParamField body="notes" type="string">
  Replacement text for the internal notes field. Pass an empty string `""` to clear existing notes.
</ParamField>
...
<ResponseField name="type" type="string">
  Appointment type: `presencial` or `teleconsulta`. Not modifiable via PATCH.
</ResponseField>
...
<ResponseField name="notes" type="string">
  The current internal notes after the update. `null` if none are set.
</ResponseField>
