---
title: "List Appointments — GET /appointments"
sidebarTitle: "List"
description: "GET /appointments — retrieve a paginated list of appointments for your clinic. Filter by date range, status, and professional."
---
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Appointment object">
    ...
    <ResponseField name="notes" type="string">
      Internal notes attached to the appointment. May be `null`.
    </ResponseField>
