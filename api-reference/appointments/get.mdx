---
title: "Fetch a Single Appointment — GET /appointments/{id}"
sidebarTitle: "Get"
description: "Retrieve a single appointment by its UUID, including its current status, payment details, and video link for teleconsulta appointments."
---
