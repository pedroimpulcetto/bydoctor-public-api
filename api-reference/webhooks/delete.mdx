---
title: "Delete a Webhook Endpoint — DELETE /webhooks/{id} | ByDoctor"
sidebarTitle: "Delete"
description: "Permanently remove a webhook endpoint. Event delivery stops immediately and any queued retries are cancelled. This action cannot be undone."
---
