---
title: "List Webhook Endpoints — GET /webhooks | ByDoctor API"
sidebarTitle: "List"
description: "Retrieve all registered webhook endpoints for your clinic, including subscribed event types and active status. The signing secret is never returned."
---
