---
title: "Register a Webhook Endpoint — POST /webhooks"
sidebarTitle: "Create"
description: "POST /webhooks — register a new HTTPS endpoint to receive ByDoctor event notifications. Returns a signing secret."
---
