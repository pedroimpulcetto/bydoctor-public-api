---
title: "Create a Patient Record — POST /patients | ByDoctor API"
sidebarTitle: "Create"
description: "Register a new patient in your clinic. Only the patient's name is required — all other fields can be added later via the Update Patient endpoint."
---
