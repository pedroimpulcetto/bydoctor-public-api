---
title: "Update Patient — PATCH /patients/{id}"
sidebarTitle: "Update"
description: "PATCH /patients/{id} — update patient contact details, health plan, or other fields. All fields are optional."
---
