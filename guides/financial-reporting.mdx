...
description: "Use the Payments API and webhooks to build financial dashboards, automate accounting exports, reconcile health plan payments, and track revenue by payment method."
---
